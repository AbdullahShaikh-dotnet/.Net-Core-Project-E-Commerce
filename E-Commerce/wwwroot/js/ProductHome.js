...
//    fetch(filterButton.dataset?.url, {
//        method: "POST",
//        body: formData,
...
//            let page = parseInt(document.getElementById("hfcurrentPage")?.value);
...
//            document.getElementById("prevPageBtn").dataset.page = page - 1;
//            document.getElementById("nextPageBtn").dataset.page = page + 1;
...
//            document.getElementById("nextPageBtn").disabled = page >= totalPages;
//        })
//        .catch(error => console.error("Error fetching page:", error)).finally(() => { if (element) btnLoaderHide(element) });
//}
