    ...
    DT = new DataTable(tableElement, {
        ...
        columns: [
            ...
            { data: 'category.name', title: 'category name' },
            {
                ...
                data: 'imageURL',
                render: function (d) {
                    return d ? `<a href="${d}" target="_blank" class="flex justify-center">
                                    <img src=${d} width="50" height="30" />
                                </a>` : '';
                },
                className: 'text-center',
                orderable: false,
                ...
                render: function (d) {
                    return `
                    	<div class="flex justify-between text-center">
                            ...
                            <button class="text-red-500 btnDelete" onclick='DeleteConfirmation("${DeleteURL + d}")'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
