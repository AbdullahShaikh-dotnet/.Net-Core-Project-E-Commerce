...
const showLoader_Cards = function () {

    const cardIdsObject =
        ["inProgressTotalCount", "paymentPendingTotalCount", "completeTotalCount", "approvedTotalCount", "cancelledTotalCount", "delayedPaymentTotalCount"];

    cardIdsObject.forEach(el => document.getElementById(el).innerHTML =
